...
typedef  enum { SUCCESS_LOGIN_RESPONSE, WRONG_CREDENTIALS_RESPONSE, ACCEPTED_CONNECTION_RESPONSE, REJECTED_CONNECTION_RESPONSE, WRONG_PROTOCOL_BEHAVIOR_RESPONSE, OK_RESPONSE, FAILED_RESPONSE, ALREADY_CONNECTED_RESPONSE } RESPONSE_TYPE;
...
#define USER_ALREADY_CONNECTED (1<<10)
